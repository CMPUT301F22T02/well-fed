...
public class MealPlanDB {
	 ...
	 */
	private final CollectionReference mealPlanCollection;
	...
	public void addMealPlan(MealPlan mealPlan, OnAddMealPlanListener listener) {
		...
		int numOfIngredientsAndRecipes = mealPlan.getIngredients().size() +
	...
	public void addMealPlanHelper(HashMap<String, Object> mealPlanMap,
		...
		this.mealPlanCollection
			...
			.addOnFailureListener(failure -> listener.onAddMealPlanResult(null, false));
	}
	...
	public void getMealPlan(String id, OnGetMealPlanListener listener) {
		...
		mealPlanRef.get()
			.addOnSuccessListener(mealPlanDoc -> getMealPlan(mealPlanDoc, listener))
			// If the MealPlan document is not found, return null.
			.addOnFailureListener(failure -> listener.onGetMealPlanResult(null, false));
	}
	...
	public void getMealPlan(DocumentSnapshot snapshot,
		...
		// the snapshot.
		assert mealPlanIngredients != null;
		int numOfIngredientsAndRecipes =
			mealPlanIngredients.size() + ((ArrayList<DocumentReference>)
				Objects.requireNonNull(snapshot.get("recipes"))).size();
		...
		for (DocumentReference recipeRef :
			(ArrayList<DocumentReference>) Objects.requireNonNull(snapshot.get(
				"recipes"))) {
	...
	public void delMealPlan(MealPlan mealPlan,
		...
		mealPlanRef.delete().addOnSuccessListener(success -> listener.onDeleteMealPlanResult(mealPlan, true)).addOnFailureListener(failure -> listener.onDeleteMealPlanResult(mealPlan, false));
	}
	...
	public void getMealPlans(OnGetMealPlansListener listener) {
		...
		}).addOnFailureListener(failure -> listener.onGetMealPlansResult(null, false));
	}
	...
	public void updateMealPlanHelper(MealPlan mealPlan,
		...
		).addOnSuccessListener(success -> listener.onUpdateMealPlanResult(mealPlan, true)).addOnFailureListener(failure -> listener.onUpdateMealPlanResult(mealPlan, false));
	}
