...
public class MealBookFragment extends Fragment implements Launcher<MealPlan>,
	...
	public void onViewCreated(@NonNull View view,
							  @Nullable Bundle savedInstanceState) {
		TextView userFirstNameTextView = view.findViewById(R.id.userFirstNameTextView);
		this.callToActionTextView =
			view.findViewById(R.id.callToActionTextView);
		RecyclerView mealPlanRecyclerView = view.findViewById(R.id.mealPlanRecyclerView);
	 ...
	 */
	@Override
	public void onItemLoad(MealPlan mealPlan) {
		Date today = new Date();
