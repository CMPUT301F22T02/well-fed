...
public class StorageIngredientDB {
	 ...
	 * Gets a query for StorageIngredients in Firestore
	 *
	 * @param query The query to search for in StorageIngredients
	 *              The query is searched for in the description of the
	 *              ingredient and the category of the ingredient or the
	 *              location of the ingredient
	 *              The query is case insensitive
	 *              The query is split by spaces and each word is searched
	 *              for individually
	...
	/**
	 * Gets ingredients from the Firebase DB sorted ascending by the given field
	 *
