...
public class RecipeAdapter extends DBAdapter<RecipeAdapter.ViewHolder> {
	...
	public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
		...
		String prepTimeText = Objects.requireNonNull(recipeSnapshot.getData()).get("preparation-time") +
			" mins";
		prepTime.setText(prepTimeText);
		recipeTitle.setText(recipe.getTitle());
		category.setText(recipeSnapshot.getString("category"));
		String servingsText =
			"Serves: " + (Objects.requireNonNull(recipeSnapshot.getData().get("servings")));
