...
public class RecipeContract
        extends ActivityResultContract<Recipe, Pair<String, Recipe>> {
     ...
     *
     * @param i      a status code representing whether the activity
     *               succeeded or not
     ...
     */
    @Override public Pair<String, Recipe> parseResult(int i,
