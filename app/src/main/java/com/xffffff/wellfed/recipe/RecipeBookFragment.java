...
public class RecipeBookFragment extends Fragment
        implements Launcher<Recipe>, RecipeAdapter.RecipeLauncher,
    ...
    @Nullable @Override public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_recipe_book, container,
                false);
    }
     ...
     * the recipes at pos.
     */
    @Override public void launch(Recipe recipe) {
        if (recipe == null) {
