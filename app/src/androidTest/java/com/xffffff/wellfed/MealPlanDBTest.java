...
/**
 * Tests for the MealPlanDB. Please note: These tests require functional
 * StoredIngredientDB
 * and RecipeDB. This is because the MealPlanDB requires that all
 * StoredIngredient and
 * RecipeIngredients exist in the database before attempting to create a
 * MealPlan.
 * <p>
 * Unfortunately, due to the nature of the database, it is hard to test only
...
public class MealPlanDBTest {
     ...
     */
    @Test public void testAddMealPlan() throws InterruptedException {
        ...
        AtomicReference<MealPlan> obtainedMealPlanReference =
                new AtomicReference<>();
     ...
     */
    @Test public void testAddMealPlanWithRecipe() throws InterruptedException {
        ...
        CountDownLatch addLatch = new CountDownLatch(1);
        AtomicReference<MealPlan> mealPlanAddReference =
                new AtomicReference<>();
        mealPlanDB.addMealPlan(mealPlan, (addedMealPlan, success) -> {
            assertTrue(success);
        ...
        CountDownLatch getLatch = new CountDownLatch(1);
        AtomicReference<MealPlan> mealPlanGetReference =
                new AtomicReference<>();
        mealPlanDB.addMealPlan(mealPlan, (retrievedMealPlan, success) -> {
            assertTrue(success);
     ...
     */
    @Test public void testAddRecipeToMealPlan() throws InterruptedException {
        // Create a mock recipe
        Recipe recipe = mockRecipe();
     ...
     */
    @Test public void testAddMealPlanWithIngredient()
        ...
        mealPlanDB.getMealPlan(mealPlan.getId(),
                (retrievedMealPlan, success) -> {
                    assertTrue(success);
     ...
     */
    @Test public void testAddIngredientToMealPlan()
            throws InterruptedException {
        // Create a mock ingredient
        Ingredient ingredient = mockIngredient();
        // Create a mock meal plan
    ...
    /**
     * Test adding a MealPlan with a 2 ingredients and 3 recipes to the
     * database.
     * Will not add Recipes and Ingredients to the DB beforehand.
     * This also acts to test the db's ability to handle adding new recipes &
     * ingredients
     * from a MealPlan.
     */
    @Test public void testAddMealPlanWithIngredientsAndRecipes()
            throws InterruptedException {
        // CountDownLatch to wait for the meal plan to be added
     ...
     */
    @Test public void testAdd2MealPlansDeleteSecond()
            throws InterruptedException {
        // Create a meal plan
        MealPlan mealPlan = mockMealPlan();
        MealPlan mealPlan2 = mockMealPlan();
        ...
        AtomicReference<ArrayList<MealPlan>> mealPlansRef =
                new AtomicReference<>();
        ...
        AtomicReference<ArrayList<MealPlan>> retrievedMealPlansRef =
                new AtomicReference<>();
        mealPlanDB.getMealPlans((retrievedMealPlans, success) -> {
            assertTrue(success);
        ...
        assertEquals(mealPlansRef.get().size() - 1,
                retrievedMealPlansRef.get().size());
     ...
     */
    @Test public void testUpdateMealPlan() throws InterruptedException {
        MealPlan mealPlan = mockMealPlan();
        // Add the meal plan to the database
        CountDownLatch addMealPlanLatch = new CountDownLatch(1);
        AtomicReference<MealPlan> addMealPlanRef = new AtomicReference<>();
     ...
     */
    @Test public void testAddMealPlanWith5Ingredients()
            throws InterruptedException {
     ...
     */
    @Test public void testAddMealPlanWith5DifferentIngredients()
            throws InterruptedException {
        // CountDownLatch to wait for the asynchronous calls to finish
        CountDownLatch mealPlanLatch = new CountDownLatch(1);
        // Create a meal plan
        ...
        mealPlan.addIngredient(
                mockIngredient("Banana", "Fruit", 5.0, "bananas"));
        mealPlan.addIngredient(mockIngredient("Apple", "Fruit", 4.0, "apples"));
        mealPlan.addIngredient(
                mockIngredient("Orange", "Fruit", 3.0, "oranges"));
        mealPlan.addIngredient(mockIngredient("Pear", "Fruit", 2.0, "pears"));
        mealPlan.addIngredient(mockIngredient("Grape", "Fruit", 1.0, "grapes"));
     ...
     */
    @Test public void testAddMealPlanWith5Recipes()
            throws InterruptedException {
        // CountDownLatch to wait for the asynchronous calls to finish
        CountDownLatch mealPlanLatch = new CountDownLatch(1);
        // Create a meal plan
     ...
     */
    @Test public void testAddMealPlanWith5DifferentRecipes()
            throws InterruptedException {
        // CountDownLatch to wait for the asynchronous calls to finish
        CountDownLatch mealPlanLatch = new CountDownLatch(1);
        // Create a meal plan
